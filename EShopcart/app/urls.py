...
urlpatterns = [
    ...
    path('painting/<slug:data>', views.painting, name='paintingdata'),
    path('handcraft/<slug:data>', views.handcraft, name='handcraftdata'),
    path('subscription/<slug:data>', views.subscription, name='subscriptiondata'),
